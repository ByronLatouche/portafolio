...
function imagegridly_scripts() {
	...
	wp_enqueue_script( 'imagegridly-accessibility', get_template_directory_uri() . '/js/accessibility.js', array(), '20160720', true );
 ...
 */
function imagegridly_remove_elementor_onboarding()
{
    update_option('elementor_onboarded', true);
}
add_action('after_switch_theme', 'imagegridly_remove_elementor_onboarding');





add_action('admin_init', 'imagegridly_spbThemesNotification', 8);

function imagegridly_spbThemesNotification(){
	$notifications = include('inc/admin_notification/Autoload.php');
	$notifications->Add("imagegridly_notification", "Unlock All Features with Image Gridly Premium – Limited Time Offer", "
		
		Take advantage of the up to <span style='font-weight:bold;'>40% discount</span> and unlock all features with Image Gridly Premium. 
		The discount is only available for a limited time.

		<div>
		<a style='margin-bottom:15px;' class='button button-large button-secondary' target='_blank' href='https://superbthemes.com/imagegridly/'>Read More</a> <a style='margin-bottom:15px;' class='button button-large button-primary' target='_blank' href='https://superbthemes.com/imagegridly/'>Upgrade Now</a>
		</div>
	...
	$notifications->Add("imagegridly_notification_start", "Let's get you started with Image Gridly!", '
		...
		<a href="https://superbthemes.com/demo/imagegridly/" target="_blank" class="button">View Image Gridly Demo <span aria-hidden="true" class="dashicons dashicons-external"></span></a> 

		</span>
		<span class="st-notification-column">
		<h2>Customize Image Gridly</h2>
		<ul>
		...
		Image Gridly is created by SuperbThemes. We have 100.000+ users and are rated <strong>Excellent</strong> on Trustpilot <img src="'. esc_url( get_template_directory_uri() . '/inc/admin_notification/src/stars.svg' ).'" width="87" height="16" />
		</span>
		</span>
